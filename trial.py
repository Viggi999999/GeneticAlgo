# -*- coding: utf-8 -*-
"""
Created on Thu May  2 10:34:18 2019
...
dfData = pd.read_csv("E:/Datasets/train.csv")

# Encode the classification labels to numbers
# Get classes and one hot encoded feature vectors
le = LabelEncoder()
le.fit(dfData['Cover_Type'])
allClasses = le.transform(dfData['Cover_Type'])
allFeatures = dfData.drop(['Cover_Type'], axis=1)
...
if __name__ == '__main__':
	...
	'''
	Here, Apply the model  you have previously trained to get a baseline accuracy
	'''
	...
	'''
	Now, we will apply a genetic algorithm to choose a subset of features that gives an better accuracy than the baseline.
	'''
	hof = getHof()
